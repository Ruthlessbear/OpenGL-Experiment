...
//sphere clip
//uniform vec4 clip_plane = vec4(1.0, 1.0, 1.0, 0.85);
//uniform vec4 clip_sphere = vec4(0.0, 0.0, 0.0, 4.0);

void main()
{
    //clip
    //    gl_ClipDistance[0] = dot(vec4(aPos.xyz, 1.0), clip_plane);
    //    gl_ClipDistance[1] = length(aPos.xyz / 1.0 - clip_sphere.xyz) - clip_sphere.w;
